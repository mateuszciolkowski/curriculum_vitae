    ...
    <div className={`${PAPER_BG} min-h-screen text-stone-900 dark:text-stone-100 antialiased selection:bg-orange-700/20`}>
      ...
      >
        ...
        <header className="pt-16 pb-12 lg:pt-24 lg:pb-16">
          ...
          <h1 className={`mt-4 font-['Instrument_Serif'] text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-normal leading-[0.95] tracking-tight transition-all duration-1000 delay-150 ease-[var(--ease-out)] ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
